// backend/middleware/fileAccess.ts
 ...
 */
function fileAccessControl(req: any, res: any, next: any) {
  const user = req.user;
 ...
 */
async function logFileAccess(user_id: any, file_path: any, file_type: any, access_status: any, user_role: any) {
  try {
 ...
 */
async function verifyFilePermission(req: any, res: any, next: any) {
  try {
    const user = req.user;
 ...
 */
async function getFileAccessLogs(user_id: any, start_date: any, end_date: any) {
  try {
    let sql = `
