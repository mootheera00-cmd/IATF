...
router.post('/submit', authRequired, (req: any, res: any) => {
  const db = req.db;
...
// Review Document
router.post('/review', authRequired, (req: any, res: any) => {
  const db = req.db;
...
router.post('/approve', authRequired, (req: any, res: any) => {
  const db = req.db;
...
router.get('/status/:id', authRequired, (req: any, res: any) => {
  const db = req.db;
