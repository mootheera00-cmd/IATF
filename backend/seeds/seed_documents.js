...
async function seed() {
    try {
        ...
        await run(`INSERT INTO DocumentRevision (id, document_id, rev_code, status, original_uri, pdf_uri, created_by) VALUES (?, ?, ?, 'Released', 'uploads/source/DOC-001-revA.docx', 'uploads/pdf/DOC-001-revA.pdf', 1)`, [1, 1, 'A', 'uploads/source/DOC-001-revA.docx', 'uploads/pdf/DOC-001-revA.pdf', 1]);
