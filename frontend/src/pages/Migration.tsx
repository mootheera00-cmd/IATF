...
export default function Migration() {
  ...
  const [files, setFiles] = useState<{ pdf: File | null; source: File | null }>({
    pdf: null,
    source: null
  });
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>, type: 'pdf' | 'source') => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const token = localStorage.getItem('token') || JSON.parse(localStorage.getItem('nsk_user') || 'null')?.token;
