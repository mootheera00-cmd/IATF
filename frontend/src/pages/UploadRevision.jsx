// frontend/src/pages/UploadRevision.jsx
...
export default function UploadRevision() {
  ...
  const isAllowedSourceFile = (name) => {
  ...
  const handleDrag = (e, type, isDrag) => {
    e.preventDefault();
    e.stopPropagation();
    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-2xl p-8">
        ...
        <p className="text-gray-600 mt-3">
          Upload revised source and PDF, then select checker. Approver is auto-assigned by system using document level.
        </p>
      </div>
